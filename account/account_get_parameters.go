...
// WithSovrenAccountID adds the sovrenAccountID to the account get params
func (o *AccountGetParams) WithSovrenAccountID(sovrenAccountID string) *AccountGetParams {
	o.SetSovrenAccountID(sovrenAccountID)
	return o
}

// SetSovrenAccountID adds the sovrenAccountId to the account get params
func (o *AccountGetParams) SetSovrenAccountID(sovrenAccountID string) {
	o.SovrenAccountID = sovrenAccountID
}

// WithSovrenServiceKey adds the sovrenServiceKey to the account get params
func (o *AccountGetParams) WithSovrenServiceKey(sovrenServiceKey string) *AccountGetParams {
	o.SetSovrenServiceKey(sovrenServiceKey)
	return o
}

// SetSovrenServiceKey adds the sovrenServiceKey to the account get params
func (o *AccountGetParams) SetSovrenServiceKey(sovrenServiceKey string) {
